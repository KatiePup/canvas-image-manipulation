...
export default {
  ...
  mounted() {
    ...
    // Somehow do this programatically from css - https://stackoverflow.com/questions/2588181/canvas-is-stretched-when-using-css-but-normal-with-width-height-properties
